...
models is 224 × 224 × 3 = 150 528 pixels
...
with spacing 0.66 × 0.66 × 0.30 mm,
is 512 × 512 × 1069 = 280 231 936 voxels
...
![Training with patches](../images/diagram_patches.svg)

- [Training](training.md) — patch samplers and queue for training
- [Inference](inference.md) — grid sampler and aggregator for dense inference
