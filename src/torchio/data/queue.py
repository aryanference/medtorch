...
class Queue(Dataset):
    ...
    ![Training with patches](https://raw.githubusercontent.com/medtorch/medtorch/main/docs/images/diagram_patches.svg)
    ...
    def memory_usage_bytes(self) -> int:
        """Estimated upper bound of queue memory usage in bytes."""
