...
class KeepLargestComponent(LabelTransform):
    ...
    Note:
        ...
        extending this transform, please [open a new issue](https://github.com/medtorch/medtorch/issues/new?assignees=&labels=enhancement&template=feature_request.md&title=Improve%20KeepLargestComponent%20transform).
